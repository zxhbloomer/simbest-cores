...
public class BigDecimalUtils {
	public static void main(String[] args) {		
		...
		System.out.println(BigDecimalUtils.div(10, 3)); 
		System.out.println(BigDecimalUtils.div(10, 3, 2));
		System.out.println(BigDecimalUtils.round(1.191, 2));
		System.out.println(BigDecimalUtils.round(1.195, 2));
		System.out.println(BigDecimalUtils.roundDown(1.191, 2));
		System.out.println(BigDecimalUtils.roundDown(1.195, 2));
		System.out.println(BigDecimalUtils.compareTo(new BigDecimal("0"), new BigDecimal("0.00")));
	}
	/**
